        ...
        if (config.kind === "service") {
            ...
            if ("copy" in config) {
                let paths = [].concat({
                    ...
                    resolvedPath: resolve(config.root, "./app/app.js"),
                    original: "./app.js"
                }, {
                    ...
                    resolvedPath: resolve(config.root, "./build"),
                    original: "./build"
                });
            ...
            if (!fs.existsSync(`${config.buildPath}/package.json`)) {
                ...
                writeFileSync(`${config.buildPath}/app/app.js`, readFileSync(__dirname + "/../templates/app.js.ejs").toString());
